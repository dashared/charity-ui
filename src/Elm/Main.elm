...
view model =
  let
      body =  if model.window.width > 750 then
                viewMedium model
              else
                viewSmall model
  in
      ...
      E.column
        ...
        [ E.row
            ...
            , E.row
                ...
                (List.map (Elm.Ui.link [ E.alignRight ]) toplevel)
            ]
          , E.row 
            [ E.width E.fill ]
            [
        ...
        , E.row
              ...
              (List.map Elm.Ui.grayLink sources) ++ [E.text "© 2021 Charity CRM"]
          ]
      ]
    ...
    [ container <| 
      E.column
        ...
        [ E.row
            ...
            (charityTitle 20 :: List.map (Elm.Ui.link [ E.paddingXY 5 0, F.size 13 ]) toplevel)
          , E.row 
            [ E.width E.fill ]
            [ E.el 
              [ E.width E.fill
...
descriptionText model = 
  E.textColumn
    ...
    [ E.paragraph  [F.center] [  E.text "Our goal is to ensure transparency of actions. We strive to be open and honest about donations."
      ]
    ]

authButton : E.Element msg
authButton  = 
  Elm.Ui.linkButton "/login" "Log in" []
...
featureImage feature =
  E.el
    [ E.width E.fill ] <| E.el [ E.width E.fill ] <| feature.image
...
sources : List Link
sources = [ Link "Facebook" "", Link "Instagram" "" ]

features : List (Feature msg)
features = 
  let paragraphLinked url label content  =
