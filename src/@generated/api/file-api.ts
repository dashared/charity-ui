...
/**
 * Request parameters for uploadPost operation in FileApi.
 * @export
 * @interface FileApiUploadPostRequest
 */
export interface FileApiUploadPostRequest {
    /**
     * File
     * @type {object}
     * @memberof FileApiUploadPost
     */
...
export class FileApi extends BaseAPI {
     ...
     * 
     * @summary Uploads given file
     * @param {FileApiUploadPostRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof FileApi
     */
    public uploadPost(requestParameters: FileApiUploadPostRequest = {}, options?: any) {
        return FileApiFp(this.configuration).uploadPost(requestParameters.file, options).then((request) => request(this.axios, this.basePath));
    }
}
